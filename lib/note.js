...
var Note = (function(){
  var _nameS = Symbol('name');
  var _rootS = Symbol('root');
  var _rootNameS = Symbol('rootName');
  var _alterationS = Symbol('alteration');
  var _octaveS = Symbol('octave');
  var _notationTypeS = Symbol('notationType');
  ...
  function Note(name){
    ...
    //Add a standard name function for all objects?
    //can we return the name in object litteral?
  }

  Note.prototype.getName = function(){return this[_nameS]};
  Note.prototype.setName = function(newName){this[_nameS] = newName};

  Note.prototype.getRoot = function(){return this[_rootS]};
  Note.prototype.setRoot = function(newRoot){this[_rootS] = newRoot};
  ...
  Note.prototype.getRootName = function(){return this[_rootNameS]};
  Note.prototype.setRootName = function(newRootName){this[_rootNameS] = newRootName};
  //all calculation are based on notes as letters
  ...
  Note.prototype.getAlteration = function(){return this[_alterationS]};
  Note.prototype.setAlteration = function(newAlteration){this[_alterationS] = newAlteration};

  Note.prototype.getOctave = function(){return this[_octaveS]};
  Note.prototype.setOctave = function(newOctave){this[_octaveS] = newOctave};

  Note.prototype.getNotationType = function(){return this[_notationTypeS]};
  Note.prototype.setNotationType = function(newNotationType){this[_notationTypeS] = newNotationType};
