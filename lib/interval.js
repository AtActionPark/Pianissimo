...
function Interval(arg1,arg2){
  ...
  //n1,n2,semitones,order,number,quality,name.qualityText,numberText
...
const setIntervalInSemitones = function(interval){
  let oct1 = interval.n1.getOctave();
  let rootNote1 = interval.n1.getRootAsLetter();
    
  let oct2 = interval.n2.getOctave();
  let rootNote2 = interval.n2.getRootAsLetter();
...
const setIntervalNumber = function(interval){
  let oct1 = interval.n1.getOctave();
  let rootNote1 =interval.n1.getRootNameAsLetter();

  let oct2 = interval.n2.getOctave();
  let rootNote2 = interval.n2.getRootNameAsLetter();
...
const setIntervalOrder = function(interval){
  ...
  if (semitones>0)
    ...
    interval.order = ''
    let note1BaseName = interval.n1.getRootNameAsLetter()
    let note2BaseName = interval.n2.getRootNameAsLetter()
